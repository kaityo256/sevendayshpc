---
title: "Day 2: スパコンの使い方"
description: ジョブスケジューラと並列ファイルシステムを学ぶ
sidebar:
  order: 4
---
...
![スパコンの構成](/sevendayshpc/ja/day2/fig/kousei.png)
...
![大規模計算のイメージ](/sevendayshpc/ja/day2/fig/nawatobi.png)
...
また、東工大では更なるスパコン利用の裾野を広げるためとして「[TSUBAME若手・女性利用者、より若い世代の利用者支援制度](https://www.gsic.titech.ac.jp/encouragement_program)」により、大学生、高校生、高専生を対象とした課題公募も行われているようだ。
...
![ジョブスケジューラ](/sevendayshpc/ja/day2/fig/supercomputer.png)
...
![ジョブスクリプトとジョブの投入](/sevendayshpc/ja/day2/fig/job.png)
...
![フェアシェアについて](/sevendayshpc/ja/day2/fig/fairshare.png)
...
![ジョブのバックフィル](/sevendayshpc/ja/day2/fig/backfill.png)
...
![ファイルアクセスもネットワークを使う](/sevendayshpc/ja/day2/fig/crowded.png)
...
![ステージングのイメージ](/sevendayshpc/ja/day2/fig/staging.png)
...
![Lustreの仕組み](/sevendayshpc/ja/day2/fig/lustre.png)
