...
---
title: "Day 5: 二次元反応拡散方程式"
description: Gray-ScottモデルをMPIで並列化する
sidebar:
  order: 7
---
...
![反応拡散方程式シミュレーションの実行結果](/sevendayshpc/ja/day5/fig/gs.png)
...
![通信の「のりしろ」](/sevendayshpc/ja/day5/fig/margin.png)
...
![データの集約](/sevendayshpc/ja/day5/fig/gather.png)
...
![x軸方向の通信](/sevendayshpc/ja/day5/fig/sendrecv_x.png)

左右の通信が終わったら、左右からもらったデータも込みで上下に転送する。以下は、「下から受け取り、上に送る」通信。

![y軸方向の通信](/sevendayshpc/ja/day5/fig/sendrecv_y.png)
...
![シリアル版とMPI版の時間発展の比較](/sevendayshpc/ja/day5/fig/serial_and_mpi.png)
