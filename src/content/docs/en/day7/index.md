...
Dump the coordinates after time evolution and compare the results. Let [mag.cpp](https://github.com/kaityo256/sevendayshpc/blob/master/day7/magnetic/mag.cpp) be the serial version and [mag_simd.cpp](https://github.com/kaityo256/sevendayshpc/blob/master/day7/magnetic/mag_simd.cpp) the SIMD version. Compile, run, and compare them as follows.
